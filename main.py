...
def user_for_genre(genre: str):
    ...
    # Cargar datos de juegos y géneros
    ...
    # Cargar datos de usuarios y horas jugadas
    ...
    df_genres_hours = df_games_genres.merge(df_users_horas, on='item_id', how='right')

    # Filtrar el DataFrame resultante para obtener solo las filas relacionadas con el género dado
